...
<body>
    <div class="admin-wrapper">
        ...
        <main class="admin-main">
            ...
            <div class="card">
                <div class="card-body">
                    <p>Content for Admin Categories goes here.</p>
                    <!-- Table, forms, etc. for managing categories -->
                </div>
            </div>
        </main>
    </div>
    ...
    <?php /* Assuming you might have a specific JS file for admin categories */ ?>
    <?php /* <script src="<?php echo ASSETS_URL; ?>/js/admin_categories.js"></script> */ ?>
</body>
</html> 