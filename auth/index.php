                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="text-center mt-3">
                                <?php if ($action === 'login'): ?>
                                    <p>Don't have an account? <a href="<?php echo BASE_URL; ?>/auth?action=register">Register here</a></p>
                                <?php else: ?>
                                    <p>Already have an account? <a href="<?php echo BASE_URL; ?>/auth?action=login">Login here</a></p>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
